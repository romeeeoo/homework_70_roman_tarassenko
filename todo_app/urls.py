...
from todo_app.views import IndexView, TaskView, UpdateTaskView, DeleteTaskView, \
    AllProjectsView, ProjectView, ProjectCreateView, ProjectTaskCreateView, AddUserToProjectView, \
...
urlpatterns = [
    ...
    path('project/<int:pk>/add-user', AddUserToProjectView.as_view(), name='project_add_user'),
    path('project/<int:pk>/remove-user', RemoveUserFromProjectView.as_view(), name='project_remove_user'),
